...
def main():
    ...
    if config["environment"]["EXEEXT"] == ".exe" and not args.force:
        # https://github.com/RavenProject/Redecoin/commit/d52802551752140cf41f0d9a225a43e84404d3e9
        # https://github.com/RavenProject/Redecoin/pull/5677#issuecomment-136646964
...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, use_term_control, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, last_loop=False):
    ...
    if "RAVEND" not in os.environ:
        os.environ["RAVEND"] = build_dir + '/src/redecoind' + exeext
        os.environ["RAVENCLI"] = build_dir + '/src/redecoin-cli' + exeext
