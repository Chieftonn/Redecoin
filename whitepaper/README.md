...
By using the messaging system, the holders of a token can be notified of the vote, and by automatically issuing a VOTE token to every holder of a token, the vote can be automated from the client or through a web or mobile interface using the protocol built into Redecoin.
...
[11] B. Fenton, “Redecoin: A digital peer to peer network for the facilitation of asset transfers.” https://medium.com/@redecoin/redecoin-4683cd00f83c  
[12] https://github.com/RavenProject/Redecoin  
[13] T. Black, J. Weight “X16R” Algorithm White Paper https://redecoin.org/wp-content/uploads/2018/03/X16R-Whitepaper.pdf  
