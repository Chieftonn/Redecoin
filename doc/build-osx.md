...
1. Clone the redecoin source code and cd into `redecoin`
        ...
        git clone https://github.com/RavenProject/Redecoin
        cd Redecoin
...
Raven Core is now available at `./src/redecoind`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=redecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Raven/redecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Raven/redecoin.conf"
