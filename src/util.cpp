...
void ArgsManager::ReadConfigFile(const std::string &confPath)
{
    ...
    if (!streamConfig.good()){
        ...
        if (configFile != NULL) {
            std::string strHeader = "# Redecoin config file\n"
                          "rpcuser=REDE_USER\n"
...
std::string CopyrightHolders(const std::string &strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Rede Core") == std::string::npos)
    {
        strCopyrightHolders += "\n" + strPrefix + "The Rede Core developers";
    }
