    ...
    if (!seed_id.IsNull())
    {
        ...
        if (!pwallet->GetHDChain().IsBip44()) {
            ...
            if (pwallet->GetKey(seed_id, seed)) {
                ...
                CRedecoinExtPubKey b58extpubkey;
    ...
    if (!seed_id.IsNull())
    {
        ...
        if (!pwallet->GetHDChain().IsBip44()) {
            ...
            if (pwallet->GetKey(seed_id, seed)) {
                ...
                // Get the Redecoin Ext Key from the master key
                CRedecoinExtKey b58extkey;
                b58extkey.SetKey(masterKey);
                ...
                // Get the Redecoin Ext Key from the public key
                CRedecoinExtPubKey b58extpubkey;
                b58extpubkey.SetKey(pubkey);
                ...
                // Create the Redecoin Account Ext Private Key
                CRedecoinExtKey b58accountextprivatekey;
                b58accountextprivatekey.SetKey(accountKey);

                // Create the Redecoin Account Ext Public Key
                CRedecoinExtPubKey b58actextpubkey;
