...
// Copyright (c) 2017-2020 The Redecoin Core developers
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 210000;  // Halving
	...
	uint32_t nGenesisTime = 1646929722;
	genesis = CreateGenesisBlock(nGenesisTime, 7765368, 0x1e00ffff, 2, 500 * COIN);
        ...
        // Main Seeders
		vSeeds.emplace_back("seed1.redecoin.eu", false);
		vSeeds.emplace_back("seed2.redecoin.eu", false);
		vSeeds.emplace_back("seed3.redecoin.eu", false);
		...
		vSeeds.emplace_back("kawpow.redecoin.eu", false);
        ...
        // Redecoin BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        checkpointData = (CCheckpointData) {
            {
                { 1, uint256S("0x00000aea45dc651b4f9b92c68c612be67bc555fe649d2ae04c852c51f44a8b2c")},
                { 1137, uint256S("0x0000000098dcf08c36d5b340fa718518a9edadb3166cabf6ad527a94889ab58f")},
                { 209999, uint256S("0x000000001cad7931eb2ec4c093662f0661a2a6f937d1fa5edc5f9b6eb5197d1f")},
		{ 260382, uint256S("0x000000007c94904e5b5180453af942fd73d8bd431379b21cd3c1d793f1c006b1")},
		{ 266421, uint256S("0x0000000000491504a39b19679e8741a050e9606bf96227f1fc95cb05ac466b1b")}
            }
        };

        chainTxData = ChainTxData{
            1663335000, // Fri, Fri, 16 Sep 2022 15:30:00 +0200
            6400,
            0.1 
        };
        ...
        nKAAAWWWPOWActivationTime = 1663335000; // Fri, Fri, 16 Sep 2022 15:30:00 +0200
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 2100000; // Halving
        consensus.nBIP34Enabled = true;
        consensus.nBIP65Enabled = true; // 000000000000000004c2b624ed5d7756c508d90fd0da2c7c679febfa6c4735f0
        consensus.nBIP66Enabled = true;
        consensus.nSegwitEnabled = true;
...
public:
    CRegTestParams() {
        ...
        // Redecoin BIP44 cointype in regtest
        nExtCoinType = 1;
