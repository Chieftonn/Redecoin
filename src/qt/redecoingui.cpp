...
//        toolbar->addAction(votingAction);
        ...
        labelVersionUpdate->setText("<a href=\"https://github.com/RedecoinProject/Redecoin/releases\">New Redecoin Version Available</a>");
        ...
        // Get the latest Redecoin release and let the user know if they are using the latest version
        // Network request code for the header widget
                       ...
                       if (key == "tag_name") {
                           ...
                           if (fNewSoftwareFound) {
                               ...
                               if (GetRandInt(2) == 1) {
                                   ...
                                   if (fRet) {
                                       QString link = "https://github.com/RedecoinProject/Redecoin/releases";
...
static bool ThreadSafeMnemonic(RedecoinGUI *gui, unsigned int style)
{
    bool modal = (style & CClientUIInterface::MODAL);
    // The SECURE flag has no effect in the Qt GUI.
    // bool secure = (style & CClientUIInterface::SECURE);
...
void RedecoinGUI::getLatestVersion()
{
    versionRequest->setUrl(QUrl("https://api.github.com/repos/RedecoinProject/Redecoin/releases"));
