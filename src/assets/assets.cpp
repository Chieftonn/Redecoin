...
static const std::regex REDECOIN_NAMES("^REDE$|^REDECOIN$|^REDECOINCOIN$|^#REDE$|^#REDECOIN$|^#REDECOINCOIN$");
...
bool TransferAssetFromScript(const CScript& scriptPubKey, CAssetTransfer& assetTransfer, std::string& strAddress)
{
    ...
    if (AreTransferScriptsSizeDeployed()) {
        ...
        // This fixes that issue (https://github.com/RedecoinProject/Redecoin/issues/752)
