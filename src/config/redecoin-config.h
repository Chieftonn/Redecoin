/* src/config/redecoin-config.h.  Generated from redecoin-config.h.in by configure.  */
/* src/config/redecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef REDECOIN_CONFIG_H

#define REDECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Rede Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Rede Core"
...
#define PACKAGE_BUGREPORT "https://github.com/RedecoinProject/Redecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rede Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rede Core 2.0.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "redecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://www.redecoin.eu"
