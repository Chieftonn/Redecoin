...
[Raven git repository](https://github.com/RavenProject/Redecoin) but are not part of
...
in the redecoin git repository. At present only an SVG version of the Raven
icon is used.
